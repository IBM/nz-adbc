...
make_c_tarball: build_netezza
	...
	@cp $(BUILD_DIR)/$(ADBC_DRIVER_NETEZZA_LIB) $(BUILD_DIR)/$(C_TAR_SOURCE_DIR)/$(ADBC_DRIVER_NETEZZA_LIB)
	@cp $(NETEZZA_DRIVER_LIB_DIR)/$(NETEZZA_DRIVER_LIB) $(BUILD_DIR)/$(C_TAR_SOURCE_DIR)/$(NETEZZA_DRIVER_LIB)
